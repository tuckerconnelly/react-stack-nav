...
if(__WEB__)window.history.replaceState(_stateObj,_title,_url.length?_url:'/');
return {
index:state.index,
history:state.history.
slice(0,state.index).
...
action.payload;var _stateObj2=_action$payload3.stateObj;var _title2=_action$payload3.title;var _url2=_action$payload3.url;

var _stateObjWithIndex2=_extends({},_stateObj2,{index:state.index});

var newUrl=state.history[state.index].url+'/'+_url2;

if(__WEB__)window.history.replaceState(_stateObj2,_title2,newUrl);
return {
index:state.index,
history:state.history.
slice(0,state.index).
...
action.payload;var _stateObj3=_action$payload4.stateObj;var _title3=_action$payload4.title;var _url3=_action$payload4.url;

var _stateObjWithIndex3=_extends({},_stateObj3,{index:state.index});

var _newUrl=state.history[state.index].url+'/'+_url3;

if(__WEB__)window.history.pushState(_stateObj3,_title3,_newUrl);
return {
index:state.index+1,
history:state.history.
slice(0,state.index+1).
